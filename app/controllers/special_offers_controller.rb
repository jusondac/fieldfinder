class SpecialOffersController < ApplicationController
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to special_offers_path, status: :see_other, notice: "Special offer was successfully destroyed." }
  ...
  private
    ...
    def special_offer_params
      params.expect(special_offer: [ :name, :description, :discount_percentage, :start_date, :end_date, :facility_id, :min_hours, :code, :is_active ])
    end
end
